<div>
    ...
    @endif
    <form class="w-full" action="{{ route('admin.categories_pages.store') }}" method="POST"
        ...
        <div class="grid mb-5 lg:grid-cols-2 lg:gap-6">
            ...
            <div class="col-span-2">
                <x-input-label for="title_kh" :value="__('messages.titleKh')" /><span class="text-red-500">*</span>
                <x-text-input id="title_kh" class="block w-full mt-1" type="text" name="title_kh" wire:model='name'
                    required autofocus placeholder="Title Kh" />
                <x-input-error :messages="$errors->get('title')" class="mt-2" />
            </div>
            {{-- <div class="col-span-2">
                <x-input-label for="short_description" :value="__('messages.shortDescription')" />
                <textarea id="short_description" class="block w-full p-2 mt-1 border rounded-lg bg-gray-50" name="short_description"
            ...
            <div class="relative w-full mb-5 group">
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='position' id="position" name="position"
                            class="uppercase position-select">
                            <option wire:key='position' value="">Select Position...</option>
                            @forelse ($categories as $position)
        ...
        <div class="mb-5" wire:ignore>
            <x-input-label for="description" :value="__('messages.descriptionKh')" />
            <textarea id="description" name="description">{{ $description }}</textarea>
        </div> --}}
