    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                @can('create video')
                    <x-primary-button href="{{ route('admin.categories_pages.create') }}">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 " wire:click='setSortBy("name_kh")'>
                            <div class="flex items-center cursor-pointer">
                        ...
                        {{-- <th scope="col" class="px-4 py-3">{{ __('messages.position') }}</th> --}}
                        <th scope="col" class="py-3 text-center">{{ __('messages.action') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($categoryPages as $item)
                        <tr wire:key='{{ $item->id }}'
                            ...
                            <x-table-data value="{{ $item->title_kh }}" />
                                ...
                                <div class="flex items-start justify-center gap-3">
                                    ...
                                    @can('view category')
                                        <div class="pb-1" x-data="{ tooltip: false }">
                                            <!-- Modal toggle -->
                                            <a href="{{ url('categories/' . $item->id) }}" @mouseenter="tooltip = true"
