    ...
    <div>
        <div class="p-3 h-full overflow-auto w-full">
            <div class="border-gray-200">
                <ul class="flex border pt-1 rounded-md flex-wrap text-sm font-medium text-center" id="default-tab"
                    data-tabs-toggle="#default-tab-content" role="tablist">

                    <li class="me-2" role="presentation">
                        <button class="inline-block px-5 border-b-2 py-3 rounded-t-lg hover:text-slate-800" id="dashboard-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block px-5 border-b-2 py-3 rounded-t-lg hover:border-gray-300"
                        ...
                        <form action="" class="space-y-3 w-full">
                            <div class="flex items-center gap-5">
                                <label for="website-admin"
                                    class="w-[170px] block text-sm whitespace-nowrap font-medium text-gray-900">Exchange
                                    Rate:
                                </label>
                                <div class="flex w-full">
                                    <span
                                        class="inline-flex text-xl items-center px-[18px] text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 rounded-s-md">
                                        ៛
                                    </span>
                                    <input type="text" id="website-admin"
                                        class="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 max-w-[300px] text-sm border-gray-300 p-2.5"
                                        placeholder="4100" />
                                </div>
                            </div>
                            <div class="flex items-center gap-5">
                                ...
                                <div class="flex w-full">
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-percent">
                                                ...
                                                <form class="p-4 md:p-5 w-full">
                                                    <div class="grid px-4 gap-4 mb-4 grid-cols-2">
                                                        ...
                                                        <div class="col-span-2 space-y-2">
                                                            <label
                                                                class="block pr-1 whitespace-nowrap text-sm font-medium text-gray-900"
                                                                for="small_size">Shop Logo:
                                                            </label>
                                                            <input
