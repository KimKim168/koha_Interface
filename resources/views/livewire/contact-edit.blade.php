<div>
    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-5 mb-5 lg:grid-cols-2">
            ...
            <div>
                <x-input-label for="phone_number" :value="__('messages.phoneNumber')" /><span class="text-red-500">*</span>
                <x-text-input id="phone_number" class="block w-full mt-1" type="text" name="phone_number"
                    wire:model='phone_number' required autofocus placeholder="Phone Number" />
                <x-input-error :messages="$errors->get('phone_number')" class="mt-2" />
            </div>

            <div>
                <x-input-label for="location_first" :value="__('messages.locationFirst')" /><span class="text-red-500">*</span>
                <x-text-input id="location_first" class="block w-full mt-1" type="text" name="location_first"
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="link_location_first" class="block w-full mt-1" type="text" name="link"
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="link_location_second" class="block w-full mt-1" type="text"
            ...
            <div class="flex items-center mb-5 space-4" wire:key='uploadimage'>
                @if ($image_first)
                    <div class="pt-5 max-w-40">
                        <img src="{{ $image_first->temporaryUrl() }}" alt="Selected Image"
                            class="max-w-full pr-4 max-h-40" />
                    </div>
                @else
                    <div class="pt-5 max-w-40">
                        <img src="{{ asset('assets/images/contacts/' . $contact->image_first) }}" alt="Selected Image"
                            class="max-w-full pr-4 max-h-40" />
                    </div>
                @endif
                <div class="flex flex-col flex-1">
                    ...
                    <div class="relative flex items-center justify-center w-full -mt-3 overflow-hidden">
                        <label for="dropzone-file"
                            ...
                            <input wire:model="image_first" accept="image/png, image/jpeg, image/gif"
                    ...
                    <x-input-error :messages="$errors->get('image_first')" class="mt-2" />
                </div>
            </div>
            {{-- End Image Upload --}}
        </div>
