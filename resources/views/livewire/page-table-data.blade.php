        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="py-3 text-center">{{ __('messages.titleKh') }}</th>
                    <th scope="col" class="py-3 text-center">{{ __('messages.category') }}</th>
                    <th scope="col" class="py-3 text-center">{{ __('messages.parentId') }}</th>
            ...
            <tbody>
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <x-table-data value="{{ $item->name_kh }}" class="text-center" />
                        <x-table-data class="text-center uppercase" value="{{ $item->category_id }}" />
                        <x-table-data class="text-center uppercase" value="{{ $item->parent_id }}" />
