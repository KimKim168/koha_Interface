    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-5 mb-5 lg:grid-cols-2 lg:gap-6">
            ...
            <div>
                ...
                <x-text-input id="duration" class="block w-full" type="text" name="duration" wire:model='duration'
        ...
        <div class="mb-5">
            ...
            {{-- Start file Upload --}}
            {{-- <div class="flex items-center space-4" wire:key='uploadfile' x-data="{ uploading: false, progress: 0, paused: false }"
                ...
                <div class="flex flex-col flex-1">
                    <label class='mb-4 text-sm font-medium text-gray-600 dark:text-white'>
                        {{ __('messages.uploadFile') }} : <span class="text-yellow-600">Video file not required if
                            using a YouTube link.</span>
                    </label>
                    <div class="relative flex items-center justify-center w-full -mt-3 overflow-hidden">
                        <label for="file"
                            class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <input type="file" wire:model="file" id="file" name="file" accept="video/*"
                                class="absolute h-[140%] w-[100%]" />
                        </label>
                    </div>
