<div>
    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-5 mb-5 lg:grid-cols-2">
            ...
            <div>
                <x-input-label for="working_hours" :value="__('messages.workingHours')" /><span class="text-red-500">*</span>
                <x-text-input id="working_hours" class="block w-full mt-1" type="text" name="working_hours"
                    wire:model='working_hours' required autofocus placeholder="Working Hours" />
