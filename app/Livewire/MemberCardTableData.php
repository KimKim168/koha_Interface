...
class MemberCardTableData extends Component
{
    use WithPagination;
    ...
    public function delete($id) {
        $item = MemberCards::findOrFail($id);
    ...
    public function render(){
        ...
        $items = MemberCards::where(function($query){
        ...
        $categories = MemberCardPosition::latest()->get();
        $selectedCategory = MemberCardPosition::find($this->filter);

        return view('livewire.member-card-table-data', [
            'items' => $items,
